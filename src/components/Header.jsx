...
const Header = ({
  ...
  // Updated logic for shouldShowBackButton
  const shouldShowBackButton = pagesWithBackButton.includes(currentPage) && previousPage !== null
        ...
        <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden md:flex items-center space-x-1">
              ...
              {navItems.map((item) => {
                ...
                return (
                  ...
                  >
                    {IconComponent && <IconComponent className="h-4 w-4" />} <span> {item.label} </span>{" "}
                    {currentPage === item.id && (
          ...
          <div className="flex items-center space-x-2">
            ...
            >
              ...
              <div className="absolute inset-0 rounded-xl bg-green-500/0 group-hover:bg-green-500/10 transition-colors">
                {" "}
              </div>{" "}
            </Button>{" "}
          ...
          <div className="px-4 py-4 space-y-2">
            ...
            {navItems.map((item) => {
              ...
              return (
                ...
                >
                  {IconComponent && <IconComponent className="h-5 w-5" />} <span> {item.label} </span>{" "}
                </button>
              )
            })}{" "}
          </div>{" "}
